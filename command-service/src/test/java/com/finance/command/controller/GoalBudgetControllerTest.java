...
@WebMvcTest(controllers = {GoalBudgetController.class, com.finance.command.exception.GlobalExceptionHandler.class}, excludeAutoConfiguration = SecurityAutoConfiguration.class)
...
public class GoalBudgetControllerTest {
    ...
    void createGoal_succeeds() throws Exception {
        ...
        SavingsGoalResponse response = new SavingsGoalResponse(
                ...
                false, LocalDateTime.now(), null, com.finance.command.model.Priority.MEDIUM
        );
