...
public class AnalyticsControllerTest {
    ...
    @MockitoBean
    private com.finance.query.service.GoalForecastingService goalForecastingService;

    @MockitoBean
    private com.finance.query.service.BudgetTrendService budgetTrendService;
