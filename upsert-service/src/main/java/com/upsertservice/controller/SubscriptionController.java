...
import com.upsertservice.service.SubscriptionDetectorService;
...
public class SubscriptionController {
    ...
    @GetMapping
    @Operation(summary = "Get detected subscriptions for a user")
    public ResponseEntity<List<SubscriptionResponse>> getSubscriptions(
            @RequestHeader("X-User-Id") String xUserId,
            @RequestParam UUID userId) {
        validateUser(xUserId, userId);
        return ResponseEntity.ok(service.detectAndGetForUser(userId));
    }
